...
void Sys_Init( void )
{
    ...
    Cvar_Set( "arch", "android arm" );
    
    Cvar_Set( "username", "unknown" );
...
#endif
static void FS_MyReplaceSeparators( char* path )
{
    char*    s;
...
char* FS_BuildMyPath( const char* base, const char* qpath )
{
...
#endif
{
    ...
    snprintf( fname, sizeof( fname ), "lib%s"
#ifdef __ARM_NEON__
              "n""e""o""n"
#else
              "a""r""m"
...
#define Q_RTLD    RTLD_NOW
    homepath = "/d""a""t""a""/""d""a""t""a""/""c""o""m"".""n""0""n""3""m""4"".""r""t""c""w""4""a""/""l""i""b";
    basepath = "/d""a""t""a""/""d""a""t""a""/""c""o""m"".""n""0""n""3""m""4"".""r""t""c""w""4""a""/""l""i""b";
    gamedir = "/d""a""t""a""/""d""a""t""a""/""c""o""m"".""n""0""n""3""m""4"".""r""t""c""w""4""a""/""l""i""b";
    pwdpath = "/d""a""t""a""/""d""a""t""a""/""c""o""m"".""n""0""n""3""m""4"".""r""t""c""w""4""a""/""l""i""b";
    fn = FS_BuildMyPath( pwdpath, fname );
    // bk001206 - verbose
    ...
    if( !libHandle )
    {
        Com_Printf( "failed (%s)\n", dlerror() );
        // homepath
        fn = FS_BuildMyPath( homepath, fname );
        Com_Printf( "Sys_LoadDll(%s)... ", fn );
        libHandle = dlopen( fn, Q_RTLD );
        ...
        if( !libHandle )
        {
            Com_Printf( "failed (%s)\n", dlerror() );
            // basepath
            fn = FS_BuildMyPath( basepath, fname );
            Com_Printf( "Sys_LoadDll(%s)... ", fn );
            libHandle = dlopen( fn, Q_RTLD );
            ...
            if( !libHandle )
            {
                ...
                if( 0 )    // begin BASEGAME != fs_game section
                {
