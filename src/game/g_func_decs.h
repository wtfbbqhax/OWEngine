...
extern qboolean Q_strreplace( char* dest , int destsize , const char* find , const char* replace ) ;
...
extern void Com_Memset( void* dest , const int val , const size_t count ) ;
extern void Com_Memcpy( void* dest , const void* src , const size_t count ) ;
