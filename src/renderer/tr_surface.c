...
void RB_AddQuadStampFadingCornersExt( vec3_t origin, vec3_t left, vec3_t up, byte* color, float s1, float t1, float s2, float t2 )
{
    ...
    tess.normals[ndx][0] = tess.normals[ndx + 1][0] = tess.normals[ndx + 2][0] = tess.normals[ndx + 3][0] = tess.normals[ndx + 4][0] = normal[0];
	tess.normals[ndx][1] = tess.normals[ndx + 1][1] = tess.normals[ndx + 2][1] = tess.normals[ndx + 3][1] = tess.normals[ndx + 4][1] = normal[1];
	tess.normals[ndx][2] = tess.normals[ndx + 1][2] = tess.normals[ndx + 2][2] = tess.normals[ndx + 3][2] = tess.normals[ndx + 4][2] = normal[2];
...
void RB_SurfacePolychain( srfPoly_t* p )
{
    ...
    {
        tess.indexes[tess.numIndexes + 0] = ( short )( tess.numVertexes );
        tess.indexes[tess.numIndexes + 1] = ( short )( tess.numVertexes + i + 1 );
        tess.indexes[tess.numIndexes + 2] = ( short )( tess.numVertexes + i + 2 );
        tess.numIndexes += 3;
    }
...
void RB_SurfaceTriangles( srfTriangles_t* srf )
{
    ...
    {
        tess.indexes[ tess.numIndexes + i + 0 ] = ( short )( tess.numVertexes + srf->indexes[ i + 0 ] );
        tess.indexes[ tess.numIndexes + i + 1 ] = ( short )( tess.numVertexes + srf->indexes[ i + 1 ] );
        tess.indexes[ tess.numIndexes + i + 2 ] = ( short )( tess.numVertexes + srf->indexes[ i + 2 ] );
    }
...
static void DoRailCore( const vec3_t start, const vec3_t end, const vec3_t up, float len, float spanWidth )
{
    ...
    tess.indexes[tess.numIndexes++] = ( short )( vbase );
    tess.indexes[tess.numIndexes++] = ( short )( vbase + 1 );
    tess.indexes[tess.numIndexes++] = ( short )( vbase + 2 );
    
    tess.indexes[tess.numIndexes++] = ( short )( vbase + 2 );
    tess.indexes[tess.numIndexes++] = ( short )( vbase + 1 );
    tess.indexes[tess.numIndexes++] = ( short )( vbase + 3 );
}
...
static void DoRailDiscs( int numSegs, const vec3_t start, const vec3_t dir, const vec3_t right, const vec3_t up )
{
    ...
    for( i = 0; i < numSegs; i++ )
    {
        ...
        tess.indexes[tess.numIndexes++] = ( short )( tess.numVertexes - 4 + 0 );
        tess.indexes[tess.numIndexes++] = ( short )( tess.numVertexes - 4 + 1 );
        tess.indexes[tess.numIndexes++] = ( short )( tess.numVertexes - 4 + 3 );
        tess.indexes[tess.numIndexes++] = ( short )( tess.numVertexes - 4 + 3 );
        tess.indexes[tess.numIndexes++] = ( short )( tess.numVertexes - 4 + 1 );
        tess.indexes[tess.numIndexes++] = ( short )( tess.numVertexes - 4 + 2 );
    }
}
...
void RB_SurfaceCMesh( mdcSurface_t* surface )
{
    ...
    for( j = 0 ; j < indexes ; j++ )
    {
        tess.indexes[Bob + j] = ( short )( Doug + triangles[j] );
    }
...
void RB_SurfaceFace( srfSurfaceFace_t* surf )
{
    ...
    {
        tessIndexes[i] = ( short )( indices[i] + Bob );
    }
