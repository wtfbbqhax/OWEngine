...
//  Created:
//  Compilers:
//  Description: idSound is the class that actually stores a sound.  It also has a
//               limited public API that allows you to signal a sound from the game
//               code or an entity.  We need to use signals since the sound code runs in it's own thread
