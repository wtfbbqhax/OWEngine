...
//
// -------------------------------------------------------------------------
//  File name:   idSpeaker.h
//  Version:     v1.00
//  Created:
//  Compilers:
//  Description: idSpeaker is the container class for all sound stuff.  It has static
//               members that allow you to start, stop, and so forth, and private members
//               that will not be exposed to the public API.  This class will start a
//				 thread that plays independently of the game API.
//               idSpeaker can handle various output devices, ranging from headphones, to
//               speakers, to 5.1.  The default setup is Dolby 5.1 through at least six
//               speakers (four surround, one front, and sub).
// -------------------------------------------------------------------------
//  History:
