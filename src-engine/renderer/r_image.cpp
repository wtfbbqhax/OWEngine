                      ...
                      bool noCompress )
{
    ...
    if( 1 )  //!lightMap ) {
    {
        ...
        if( samples == 3 )
        {
            /*if ( glConfig.textureCompression == TC_EXT_COMP_S3TC)
            {
...
image_t* R_CreateImageExt( const char* name, const byte* pic, int width, int height,
                           bool mipmap, bool allowPicmip, bool characterMip, int glWrapClampMode )
{
    image_t*     image;
...
static void R_CreateDlightImage( void )
{
    ...
    tr.dlightImage = R_CreateImage( "*dlight", ( byte* )data, DLIGHT_SIZE, DLIGHT_SIZE, false, false, GL_CLAMP_TO_EDGE );
}
...
void R_CreateBuiltinImages( void )
{
    ...
    tr.blackImage = R_CreateImage( "*black", ( byte* )data, 8, 8, false, false, GL_REPEAT );
    ...
    for( x = 0; x < 32; x++ )
    {
        ...
        tr.scratchImage[x] = R_CreateImage( "*scratch", ( byte* )data, DEFAULT_SIZE, DEFAULT_SIZE, false, true, GL_CLAMP_TO_EDGE );
    }
