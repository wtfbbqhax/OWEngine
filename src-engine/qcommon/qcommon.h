...
//  Created:
//  Compilers:
//  Description: definitions common between client and server, but not game
//               or ref modules
// -------------------------------------------------------------------------
//  History:
//
...
void Netchan_Setup( netsrc_t sock, netchan_t* chan, netadr_t adr, int _qport );
...
void S_ClearSoundBuffer( bool killStreaming );  //----(SA)	modified
