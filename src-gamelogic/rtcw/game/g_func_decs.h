...
extern void CalcMuzzlePointForActivate ( gentity_t * ent , vec3_t _forward , vec3_t _right , vec3_t _up , vec3_t muzzlePoint ) ;
extern void CalcMuzzlePoint ( gentity_t * ent , int weapon , vec3_t _forward , vec3_t _right , vec3_t _up , vec3_t muzzlePoint ) ;
extern bool LogAccuracyHit ( gentity_t * target , gentity_t * attacker ) ;
...
extern void weapon_venom_fire ( gentity_t * ent , bool fullmode , float aimSpreadScale ) ;
extern void VenomPattern ( vec3_t origin , vec3_t origin2 , int seed , gentity_t * ent ) ;
extern bool VenomPellet ( vec3_t start , vec3_t end , gentity_t * ent ) ;
...
extern trace_t * CheckMeleeAttack ( gentity_t * ent , float dist , bool isTest ) ;
...
extern void G_ProcessTagConnect ( gentity_t * ent , bool clearAngles ) ;
extern bool infront ( gentity_t * self , gentity_t * other ) ;
...
extern gentity_t * G_Find ( gentity_t * from , intptr_t fieldofs , const char * match ) ;
...
extern void Plane_Attack ( gentity_t * self , bool in_PVS ) ;
...
extern bool Team_GetLocationMsg ( gentity_t * ent , char * loc , int loclen ) ;
...
extern bool OnSameTeam ( gentity_t * ent1 , gentity_t * ent2 ) ;
...
extern void trap_BotReplaceSynonyms ( char * string , unsigned int context ) ;
extern void trap_UnifyWhiteSpaces ( char * string ) ;
extern void trap_BotMatchVariable ( void * match , int variable , char * buf , int size ) ;
extern int trap_BotFindMatch ( char * str , void * match , unsigned int context ) ;
...
extern void trap_AAS_SetAASBlockingEntity ( vec3_t absmin , vec3_t absmax , bool blocking ) ;
...
extern bool trap_GetTag ( int clientNum , char * tagName , orientation_t * or ) ;
...
extern bool trap_GetEntityToken ( char * buffer , int bufferSize ) ;
...
extern bool trap_EntityContactCapsule ( const vec3_t mins , const vec3_t maxs , const gentity_t * ent ) ;
extern bool trap_EntityContact ( const vec3_t mins , const vec3_t maxs , const gentity_t * ent ) ;
...
extern bool trap_AreasConnected ( int area1 , int area2 ) ;
extern void trap_AdjustAreaPortalState ( gentity_t * ent , bool open ) ;
extern bool trap_InPVSIgnorePortals ( const vec3_t p1 , const vec3_t p2 ) ;
extern bool trap_InPVS ( const vec3_t p1 , const vec3_t p2 ) ;
...
extern bool G_SpawnString ( const char * key , const char * defaultString , char * * out ) ;
...
extern bool G_ScriptAction_RemoveEntity ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_SetHealth ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_RestoreScript ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_BackupScript ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_SetRoundTimelimit ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_EndRound ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_Announce ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_SetDefendingTeam ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_SetObjectiveStatus ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_SetWinner ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_ObjectiveImage ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_ObjectiveShortAlliedDesc ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_ObjectiveAlliedDesc ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_ObjectiveShortAxisDesc ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_ObjectiveAxisDesc ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_NumberofObjectives ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_AlliedRespawntime ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_AxisRespawntime ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_OverviewImage ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MapDescription ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_AIScriptName ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_EntityScriptName ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_StartCam ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_StopSound ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_Halt ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_TagConnect ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_ResetScript ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_FaceAngles ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_Print ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MissionSuccess ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MissionFailed ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_Accum ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_AlertEntity ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_PlayAnim ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MusicQueue ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MusicFade ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MusicStop ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MusicPlay ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_MusicStart ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_PlaySound ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_Trigger ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_Wait ( gentity_t * ent , char * params ) ;
extern bool G_ScriptAction_GotoMarker ( gentity_t * ent , char * params ) ;
...
extern bool G_Script_ScriptRun ( gentity_t * ent ) ;
...
extern bool G_SaveGame ( char * username ) ;
...
extern bool validOilSlickSpawnPoint ( vec3_t point , gentity_t * ent ) ;
...
extern bool Prop_Touch ( gentity_t * self , gentity_t * other , vec3_t v ) ;
...
extern void DoorSetSounds ( gentity_t * ent , int doortype , bool isRotating ) ;
extern void Door_reverse_sounds ( gentity_t * ent ) ;
extern void finishSpawningKeyedMover ( gentity_t * ent ) ;
extern bool findNonAIBrushTargeter ( gentity_t * ent ) ;
...
extern bool IsBinaryMoverBlocked ( gentity_t * ent , gentity_t * other , gentity_t * activator ) ;
...
extern bool G_MoverPush ( gentity_t * pusher , vec3_t move , vec3_t amove , gentity_t * * obstacle ) ;
extern bool G_TryPushingEntity ( gentity_t * check , gentity_t * pusher , vec3_t move , vec3_t amove ) ;
...
extern bool visible ( gentity_t * self , gentity_t * other ) ;
...
extern int G_PredictMissile ( gentity_t * ent , int duration , vec3_t endPos , bool allowBounce ) ;
...
extern bool G_BounceMissile ( gentity_t * ent , trace_t * trace ) ;
...
extern gentity_t * Drop_Item ( gentity_t * ent , gitem_t * item , float angle , bool novelocity ) ;
...
extern void Add_Ammo ( gentity_t * ent , int weapon , int count , bool fillClip ) ;
...
extern bool G_RadiusDamage ( vec3_t origin , gentity_t * attacker , float damage , float radius , gentity_t * ignore , int mod ) ;
extern bool CanDamage ( gentity_t * targ , vec3_t origin ) ;
...
extern bool IsHeadShot ( gentity_t * targ , gentity_t * attacker , vec3_t dir , vec3_t point , int mod ) ;
extern bool IsHeadShotWeapon ( int mod , gentity_t * targ , gentity_t * attacker ) ;
...
extern bool G_canPickupMelee ( gentity_t * ent ) ;
...
extern bool CheatsOk ( gentity_t * ent ) ;
...
extern char * ClientConnect ( int clientNum , bool firstTime , bool isBot ) ;
extern void ClientUserinfoChanged ( int clientNum ) ;
extern bool G_ParseAnimationFiles ( char * modelname , gclient_t * cl ) ;
extern bool G_GetModelInfo ( int clientNum , char * modelName , animModelInfo_t * * modelInfo ) ;
extern bool G_CheckForExistingModelInfo ( gclient_t * cl , char * modelName , animModelInfo_t * * modelInfo ) ;
...
extern bool SpotWouldTelefrag ( gentity_t * spot ) ;
...
extern void G_AdjustClientPositions ( gentity_t * ent , int time , bool forward ) ;
...
extern void alarmbox_updateparts ( gentity_t * ent , bool matestoo ) ;
...
extern bool ClientInactivityTimer ( gclient_t * client ) ;
...
extern void BG_PlayerStateToEntityStateExtraPolate ( playerState_t * ps , entityState_t * s , int time , bool snap ) ;
extern void BG_PlayerStateToEntityState ( playerState_t * ps , entityState_t * s , bool snap ) ;
...
extern bool BG_CanItemBeGrabbed ( const entityState_t * ent , const playerState_t * ps ) ;
extern bool isClipOnly ( int weap ) ;
extern bool BG_PlayerTouchesItem ( playerState_t * ps , entityState_t * item , int atTime ) ;
extern bool BG_WeaponInWolfMP ( int weapon ) ;
...
extern int sscanf ( const char * buffer , const char * fmt , ... ) ;
extern int vsprintf ( char * buffer , const char * fmt , va_list argptr ) ;
extern void AddString ( char * * buf_p , char * string , int width , int prec ) ;
extern void AddFloat ( char * * buf_p , float fval , int width , int prec ) ;
extern void AddInt ( char * * buf_p , int val , int width , int flags ) ;
extern double fabs ( double x ) ;
extern int abs ( int n ) ;
extern int _atoi ( const char * * stringPtr ) ;
extern int atoi ( const char * string ) ;
extern double _atof ( const char * * stringPtr ) ;
...
extern const char * strstr ( const char * string , const char * strCharSet ) ;
extern const char * strchr ( const char * string , int c ) ;
...
extern int BG_AnimScriptEvent ( playerState_t * ps , scriptAnimEventTypes_t event , bool isContinue , bool force ) ;
...
extern int BG_AnimScriptAnimation ( playerState_t * ps , aistateEnum_t estate , scriptAnimMoveTypes_t movetype , bool isContinue ) ;
extern int BG_ExecuteCommand ( playerState_t * ps , animScriptCommand_t * scriptCommand , bool setTimer , bool isContinue , bool force ) ;
extern int BG_PlayAnimName ( playerState_t * ps , char * animName , animBodyPart_t bodyPart , bool setTimer , bool isContinue , bool force ) ;
extern int BG_PlayAnim ( playerState_t * ps , int animNum , animBodyPart_t bodyPart , int forceDuration , bool setTimer , bool isContinue , bool force ) ;
...
extern bool BG_ParseConditions ( char * * text_pp , animScriptItem_t * scriptItem ) ;
...
extern int BG_IndexForString ( char * token , animStringItem_t * strings , bool allowFail ) ;
...
extern void AICast_UpdateNonVisibility ( gentity_t * srcent , gentity_t * destent , bool directview ) ;
extern void AICast_UpdateVisibility ( gentity_t * srcent , gentity_t * destent , bool shareVis , bool directview ) ;
extern bool AICast_CheckVisibility ( gentity_t * srcent , gentity_t * destent ) ;
...
extern bool AICast_EventMatch_IntInRange ( cast_script_event_t * event , char * eventParm ) ;
extern bool AICast_EventMatch_StringEqual ( cast_script_event_t * event , char * eventParm ) ;
...
extern char * AIFunc_ChaseGoalStart ( cast_state_t * cs , int entitynum , float reachdist , bool slowApproach ) ;
...
extern void AICast_CheckDangerousEntity ( gentity_t * ent , int dangerFlags , float dangerDist , float tacticalLevel , float aggressionLevel , bool hurtFriendly ) ;
...
extern void AIChar_SetBBox ( gentity_t * ent , cast_state_t * cs , bool useHeadTag ) ;
...
extern void G_SetAASBlockingEntity ( gentity_t * ent , bool blocking ) ;
