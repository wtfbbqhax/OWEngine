...
//
// -------------------------------------------------------------------------
//  File name:   ai_cast_sight.c
//  Version:     v1.00
//  Created:
//  Compilers:
//  Description: Wolfenstein AI Character Visiblity
// -------------------------------------------------------------------------
//  History:
//
//////////////////////////////////////////////////////////////////////////////////////
...
bool AICast_CheckVisibility( gentity_t* srcent, gentity_t* destent )
{
    ...
    */
    ...
    //
    if( !AICast_VisibleFromPos( srcent->client->ps.origin, srcent->s.number, destent->client->ps.origin, destent->s.number, true ) )
    {
        return false;
    }
    //
