...
===================
*/
bool G_ScriptAction_ObjectiveShortAxisDesc( gentity_t* ent, char* params )
{
    char* pString, *token;
    char cs[MAX_STRING_CHARS];
...
===================
*/
bool G_ScriptAction_ObjectiveShortAlliedDesc( gentity_t* ent, char* params )
{
    char* pString, *token;
    char cs[MAX_STRING_CHARS];
...
===================
*/
bool G_ScriptAction_SetDefendingTeam( gentity_t* ent, char* params )
{
    char* pString, *token;
    char cs[MAX_STRING_CHARS];
    int num;
