...
============
*/
static bool AnimParseAnimConfig( playerInfo_t* animModelInfo, const char* filename, const char* input )
{
    char*    text_p, *token;
...
======================
*/
static bool UI_ParseAnimationFile( const char* filename, playerInfo_t* pi )
{
    char*        text_p, *prev;
    int len;
    int i;
