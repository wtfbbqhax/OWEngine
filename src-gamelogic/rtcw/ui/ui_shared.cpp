...
//
// -------------------------------------------------------------------------
//  File name:   ui_shared.c
//  Version:     v1.00
//  Created:
//  Compilers:
//  Description: string allocation/managment
// -------------------------------------------------------------------------
//  History:
//
//////////////////////////////////////////////////////////////////////////////////////
...
//----(SA)	added
bool ItemParse_textsavegame( itemDef_t* item, int handle )
{
...
//----(SA)	added
bool MenuParse_onROQDone( itemDef_t* item, int handle )
{
    menuDef_t* menu = ( menuDef_t* )item;
