...
======================
*/
static bool CG_ParseAnimationFiles( const char* modelname, clientInfo_t* ci, int client )
{
    char text[100000];
...
==============
*/
static bool CG_RegisterAcc( clientInfo_t* ci, const char* modelName, const char* skinName, qhandle_t* model, qhandle_t* skin )
{
...
bool CG_CheckForExistingModelInfo2( clientInfo_t* ci, char* modelName, animModelInfo_t** modelInfo )
{
    int i;
...
bool CG_GetModelInfo( clientInfo_t* ci, char* modelName, animModelInfo_t** modelInfo )
{
...
//----(SA) modified this for head separation
bool CG_RegisterClientModelname( clientInfo_t* ci, const char* modelName, const char* skinName )
{
    char namefromskin[MAX_QPATH];
    char filename[MAX_QPATH];
    char name[MAX_QPATH];
...
//----(SA)	end
    ...
    else if( es->aiChar == AICHAR_ZOMBIE )
    {
        ...
        if( es->time2 )
        {
            ...
            {
                ent->shaderRGBA[3] = ( unsigned char )( ( alpha - 0.5 ) * 2.0 * 255 );
            }
            //
...
void CG_AnimPlayerConditions( centity_t* cent )
{
    ...
    {
        BG_UpdateConditionValue( es->clientNum, ANIM_COND_WEAPON, WP_BINOCULARS, true );
    }
    else
    {
...
void CG_Player( centity_t* cent )
{
    ...
    bool usingBinocs = false;              // NERVE - SMF
