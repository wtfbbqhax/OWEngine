...
//		CG_FireFlameChunks( cent, cent->lerpOrigin, forward, 1.0, true, 1 );
...
//		CG_FireFlameChunks( cent, cent->currentState.origin, cent->lerpAngles, 0.1, false, flags );
//		CG_FireFlameChunks( cent, cent->currentState.origin, cent->currentState.apos.trBase, 0.1, false, flags );
//	}
//	else
